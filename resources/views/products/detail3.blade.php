        ...
        <div class="flex flex-col lg:flex-row gap-4 md:gap-8 py-0 md:py-8">
            ...
            <div class="lg:w-3/5 px-4 md:px-2 pt-2 md:pt-0">
                ...
                <div class="flex flex-col gap-4 rounded-2xl mt-4 md:mt-0">
                    <div class="w-full bg-blue-50 border-l-4 border-black p-2 md:p-4 rounded-lg shadow-sm">
                        <div class="flex items-start gap-3">
                            <div class="text-black text-3xl font-bold">
                                <i class="fa-solid fa-info-circle"></i>
                            </div>
                            <div>
                                <h3 class="font-bold text-xs md:text-sm text-blue-800 mb-1">Cum comandăm Perdea și/sau Draperie?</h3>
                                ...
                                <p class="mt-2 text-xs md:text-sm text-blue-700">
