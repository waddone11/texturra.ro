...
@section('content')
    <x-static-page title="Politica GDPR" eyebrow="Legal">
        ...
        <p>
            ...
            - Datele sunt colectate doar în scopuri specifice, explicite și legitime;<br/>
            - Procesăm doar datele necesare pentru scopurile declarate;<br/>
            - Ne asigurăm că datele sunt exacte și actualizate.
        </p>
        <p>
            <strong>Drepturile garantate de GDPR</strong><br/>
            - Dreptul de acces: Aveți dreptul de a accesa datele personale pe care le deținem;<br/>
            - Dreptul la rectificare: Puteți solicita corectarea datelor incorecte sau incomplete;<br/>
            - Dreptul la ștergere: Aveți dreptul să solicitați ștergerea datelor dumneavoastră în anumite condiții;<br/>
            - Dreptul la portabilitate: Puteți primi datele personale într-un format structurat, utilizat în mod obișnuit, care poate fi citit automat.
        </p>
        <p>
