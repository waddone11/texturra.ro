...
{{--            poster="{{ asset('storage/images/video_bg.png') }}"--}}
    ...
    @php
        ...
        $categoryIcons = [
            'Perdele' => asset('storage/images/icons/galerii.svg'),
    ...
    <div class="max-w-7xl mx-auto mt-8 md:mt-16 mb-8 px-6 md:px-0 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px:0 md:px-4 py-8 space-y-8">
{{--            <!-- Row 1: 4 Categories -->--}}
...
{{--            </div>--}}
            <div class="w-full overflow-hidden">
                ...
                <div id="category-scroll" class="flex flex-nowrap gap-4 overflow-x-auto scroll-smooth pb-4 custom-scrollbar px-0">
                    @foreach ($topCategories as $category)
                        <div class="flex-shrink-0 w-44 sm:w-48 p-4 flex flex-col items-center text-center gap-4 transition duration-200 group bg-gray-100 rounded-xl shadow-md">
                            <a href="{{ route('products.category', ['slug' => $category->slug]) }}">
                                <img
                                    src="{{ $categoryIcons[$category->name] ?? $defaultIcon }}"
                                    alt="{{ $category->name }}"
                                    class="w-24 h-24 object-contain mx-auto transition-transform duration-300 group-hover:scale-110"
                                />
                            </a>
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-0 py-8 md:mt-8">
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-center bg-gray-100 rounded-lg p-4 shadow-lg">
                <img
                    ...
                    class="w-6 h-6 md:w-12 md:h-12 mr-2 md:mr-4"
                />
                <div>
