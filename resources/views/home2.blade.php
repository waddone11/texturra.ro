...
@section('content')
    ...
    <div class="max-w-7xl mx-auto mt-8 md:mt-16 px-6 md:px-0 relative overflow-hidden">
...
{{--                            <h1 class="text-3xl md:text-4xl font-bold mb-4 text-gray-800 mt-12">--}}
{{--                                Perdele moderne pentru orice stil--}}
{{--                            </h1>--}}
{{--                            <p class="text-base md:text-lg text-gray-700 mb-6 md:pr-6 textColor">--}}
{{--                                Descoperă colecția noastră variată de perdele, realizate din materiale ușoare și elegante,--}}
{{--                                perfecte pentru a adăuga rafinament și intimitate oricărei încăperi. Fie că preferi un stil clasic sau contemporan,--}}
{{--                                perdelele <strong>TEXTURRA</strong> transformă casa ta într-un spațiu plin de armonie.--}}
{{--                            </p>--}}
{{--                            <button class="bg-black text-white font-semibold px-4 py-2 rounded-md w-fit">--}}
{{--                                Vezi colecția--}}
{{--                            </button>--}}
{{--                        </div>--}}

{{--                        <!-- RIGHT Section -->--}}
{{--                        <div class="relative w-full md:w-2/5 px-2 md:px-8 flex items-center justify-center pt-0 pb-16 md:py-8">--}}
{{--                            --}}{{--                            <div class="relative w-[150px] md:w-[200px] h-[250px] md:h-full bg-green-500 rounded-xl flex items-center justify-center overflow-hidden shadow-xl"></div>--}}
{{--                            <img--}}
{{--                                src="{{ asset('storage/images/slide_1.png') }}"--}}
{{--                                alt="Perdele"--}}
{{--                                class="relative w-[300px] md:w-[450px] top-35 z-50"--}}
{{--                            />--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                            <h1 class="text-3xl md:text-4xl font-bold mb-4 text-gray-800 mt-12">--}}
{{--                                Draperii elegante și funcționale--}}
{{--                            </h1>--}}
{{--                            <p class="text-base md:text-lg text-gray-700 mb-6 pr-3 md:pr-6">--}}
{{--                                Alege draperii care nu doar completează designul interior, ci oferă și intimitate și protecție solară.--}}
{{--                                Modelele noastre includ texturi bogate, culori naturale și croieli moderne pentru a se potrivi perfect stilului tău.--}}
{{--                                Ideal pentru livinguri, dormitoare sau spații comerciale.--}}
{{--                            </p>--}}
{{--                            <button class="bg-green-500 text-white font-semibold px-4 py-2 rounded-md w-fit">--}}
{{--                                Explorează draperiile--}}
{{--                            </button>--}}
{{--                        </div>--}}
...
{{--                            --}}{{--                            <div class="relative w-[150px] md:w-[200px] h-[250px] md:h-full bg-green-500 rounded-xl flex items-center justify-center overflow-hidden shadow-xl"></div>--}}
{{--                            <img--}}
{{--                                src="{{ asset('storage/images/slide_2.png') }}"--}}
{{--                                alt="Draperii"--}}
{{--                                class="relative w-[300px] md:w-[450px] top-35 z-50"--}}
{{--                            />--}}
{{--                        </div>--}}
...
{{--                            <h1 class="text-3xl md:text-4xl font-bold mb-4 text-gray-800 mt-12">--}}
{{--                                Lenjerii de pat premium pentru confort desăvârșit--}}
{{--                            </h1>--}}
{{--                            <p class="text-base md:text-lg text-gray-700 mb-6 md:pr-6">--}}
{{--                                Răsfață-te cu lenjerii de pat realizate din bumbac de calitate superioară,--}}
{{--                                cu imprimeuri moderne și finisaje impecabile. Gama noastră este perfectă--}}
{{--                                pentru dormitoare care pun accent pe estetică și relaxare.--}}
{{--                                Alege confortul și eleganța, în fiecare noapte.--}}
{{--                            </p>--}}
{{--                            <button class="bg-black text-white font-semibold px-4 py-2 rounded-md w-fit">--}}
{{--                                Cumpără acum--}}
{{--                            </button>--}}
...
{{--                            --}}{{--                            <div class="relative w-[150px] md:w-[200px] h-[250px] md:h-full bg-green-500 rounded-xl flex items-center justify-center overflow-hidden shadow-xl"></div>--}}
{{--                            <img--}}
{{--                                src="{{ asset('storage/images/slide_3.png') }}"--}}
{{--                                alt="Lenjerii de pat"--}}
{{--                                class="relative w-[300px] md:w-[450px] top-35 z-50"--}}
{{--                            />--}}
{{--                        </div>--}}
...
{{--            <!-- Navigation Arrows -->--}}
{{--            <div class="swiper-button-prev hidden md:block absolute bottom-2 left-4 md:top-1/2 md:bottom-auto md:-translate-y-1/2 text-white p-2 rounded-full cursor-pointer"></div>--}}
{{--            <div class="swiper-button-next hidden md:block bottom-2 right-4 md:top-1/2 md:bottom-auto md:-translate-y-1/2 text-white p-2 rounded-full cursor-pointer"></div>--}}


{{--        </div>--}}

{{--        <!-- Progress Bar (thin line at bottom) -->--}}
{{--        <div class="absolute bottom-0 left-0 w-full h-[2px] z-50 overflow-hidden">--}}
...
{{--            <div class="w-full md:w-3/5 md:pt-12 flex flex-col justify-top mb-16 md:mb-0 px-6 md:px-0">--}}
{{--                <h1 class="text-3xl md:text-4xl font-bold mb-4 text-gray-800 mt-12">--}}
{{--                    Perdele & Draperii <span class="text-green-500">personalizate</span> pentru casa ta--}}
{{--                </h1>--}}
{{--                <p class="text-base md:text-lg text-gray-700 mb-6 md:pr-6 textColor">--}}
{{--                    Alege dimensiunile perfecte, tipul de material, rejansa sau prinderea ideală. Fiecare produs este croit--}}
{{--                    pe comandă, pentru a se potrivi exact nevoilor tale. Consultanță gratuită, calitate premium și livrare rapidă.--}}
{{--                </p>--}}
{{--                <a href="{{ route('products.category', ['slug' => 'perdele']) }}"--}}
{{--                   class="bg-black text-white font-semibold px-4 py-2 rounded-md w-fit hover:bg-gray-800 transition">--}}
...
{{--            <div class="relative w-full md:w-2/5 px-2 md:px-8 flex items-center justify-center pt-0 pb-16 md:py-8">--}}
{{--                <img--}}
{{--                    src="{{ asset('storage/images/slide_custom_curtains.png') }}"--}}
{{--                    alt="Perdele personalizate"--}}
{{--                    class="relative w-[300px] md:w-[450px] top-35 z-50"--}}
{{--                />--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
    ...
    <section class="w-full bg-white border-t border-black pt-12 pb-12">
        <div class="max-w-7xl mx-auto py-16 grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
            <!-- TEXT BLOCK -->
            ...
            <div class="col-span-2 relative w-full h-[400px] md:h-[500px] overflow-hidden border border-black rounded-lg">
                <div id="slider" class="relative w-full h-full before-after-slider ">


                    <img src="{{ asset('storage/images/tex_2.png') }}"
                         class="absolute top-0 left-0 w-full h-full object-cover z-20 before-img" alt="Before" />

                    <img src="{{ asset('storage/images/tex_3.png') }}"
                         class="absolute top-0 left-0 w-full h-full object-cover z-10 after-img" alt="After" />
