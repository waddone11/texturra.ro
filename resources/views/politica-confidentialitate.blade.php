...
@section('content')
    <x-static-page title="Politica de Confidențialitate" eyebrow="Legal">
        ...
        <p>
            ...
            - Adresa de e-mail<br/>
            - Număr de telefon<br/>
            - Adresa de livrare și de facturare<br/>
            - Istoricul comenzilor și interacțiunilor cu site-ul<br/>
        </p>
        <p>
        ...
        <p>
            <strong>Drepturile utilizatorilor</strong><br/>
            Aveți dreptul de a solicita acces la datele dumneavoastră, de a le corecta, șterge sau de a limita procesarea acestora. De asemenea, puteți să vă opuneți utilizării datelor în scopuri de marketing direct.
        </p>
        <p>
