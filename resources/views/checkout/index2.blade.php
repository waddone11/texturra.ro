                        ...
                        <form action="{{ route('checkout.apply-voucher') }}" method="POST">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button
                                    ...
                                    class="w-auto bg-black text-white text-center py-2 rounded-lg font-semibold hover:bg-gray-900 transition text-xs px-4 border border-black edit-shipping-address">
                                    Aplică
                                </button>
                            </div>
                            @error('voucher_code')
...
{{--                </div>--}}
        ...
        <div class="border bg-gray-50 shadow-xl p-4 py-2 rounded mb-6">
            <form action="{{ route('order.store') }}" method="POST">
                ...
                <button type="submit" class="bg text-white px-4 py-2 mt-4 text-sm rounded-lg hover:bg-blue-700 transition duration-200 w-full">
                    Finalizează Comanda
                </button>
            </form>
